...
namespace Snow_Monkey\Plugin\FooterCTA\App;
...
class Updater {
	...
	public function __construct() {
		...
		add_filter( 'inc2734_github_plugin_updater_zip_url_inc2734/snow-monkey-footer-cta', array( $this, '_zip_url' ) );
		add_filter( 'inc2734_github_plugin_updater_request_url_inc2734/snow-monkey-footer-cta', array( $this, '_request_url' ), 10, 4 );
	}
	...
	public function _init() {
		new Bootstrap(
			plugin_basename( SNOW_MONKEY_FOOTER_CTA_PATH . '/snow-monkey-footer-cta.php' ),
			'inc2734',
	...
	public function _request_url( $url, $user_name, $repository, $version ) {
		return ! $version
			? 'https://snow-monkey.2inc.org/github-api/snow-monkey-footer-cta/response.json'
			: sprintf(
				'https://snow-monkey.2inc.org/github-api/snow-monkey-footer-cta/packages/%1$s/response.json',
				$version
			);
	}
}
